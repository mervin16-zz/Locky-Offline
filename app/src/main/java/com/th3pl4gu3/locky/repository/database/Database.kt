...
abstract class Database : RoomDatabase() {
    ...
    companion object {
        ...
        // same time.
        @Volatile
        private var INSTANCE: com.th3pl4gu3.locky.repository.database.Database? = null

        fun getDatabase(context: Context): com.th3pl4gu3.locky.repository.database.Database {
            ...
            synchronized(this) {
                val instance = Room.databaseBuilder(
                    ...
                    com.th3pl4gu3.locky.repository.database.Database::class.java,
                    "locky_database"
                ).build()
                INSTANCE = instance
                return instance
